# XNAT-ROI OHIF Viewer Plugin 1.8.1 Beta #
...
- Replaced 302 FOUND code with IE compliant HTTP codes.
...
- If the user attempts to open a session which has no imaging data, the user is instead prompted that no data is available.
